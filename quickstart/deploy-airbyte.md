...
Alternatively, if you have an Airbyte Cloud invite, just follow [these steps.](https://github.com/taranvohra/airbyte/tree/master/docs/deploying-airbyte/on-cloud.md)
