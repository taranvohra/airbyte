...
Gitbook tracks the [`gitbook/v1` branch](https://github.com/airbytehq/airbyte/tree/gitbook/v1) from the [Airbyte repository](https://github.com/taranvohra/airbyte/tree/bazarnov/stripe-add-streams/docs/contributing-to-airbyte/github.com/airbytehq/airbyte/README.md). This branch is synced with master on every push via this [Github action](https://github.com/airbytehq/airbyte/blob/master/.github/workflows/sync-branches.yml).
