...
## CDK Speedrun (HTTP API Source Creation [Any%](https://en.wikipedia.org/wiki/Speedrun) Route)
...
{% embed url="https://www.youtube.com/watch?v=kJ3hLoNfz_E" %}
...
Now download [this file](https://github.com/airbytehq/airbyte/blob/master/airbyte-cdk/python/docs/tutorials/http\_api\_source\_assets/pokemon.json). Name it `pokemon.json` and place it in `/source_python_http_example/schemas`.
