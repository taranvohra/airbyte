...
The Facebook Pages source uses [Facebook Graph API](https://developers.facebook.com/docs/graph-api/?locale=en\_US) to read data from the Facebook social graph.
...
| 0.1.4   | 2021-11-26 |                                                        | Remove unsupported insights\_export field from Pages request              |
