...
* Fill up DynamoDB info
  ...
  * **Access Key Id**
    ...
    * We recommend creating an Airbyte-specific user. This user will require [read and write permissions](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference\_policies\_examples\_dynamodb\_specific-table.html) to the DynamoDB table.
  * **Secret Access Key**
