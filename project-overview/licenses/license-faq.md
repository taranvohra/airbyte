...
1. Provide the products to others as a managed service ([read more](https://github.com/taranvohra/airbyte/tree/bazarnov/stripe-add-streams/docs/project-overview/licenses/license-faq/README.md#what-is-the-managed-service-use-case-that-is-not-allowed-under-elv2));
...
[View License](https://github.com/taranvohra/airbyte/tree/bazarnov/stripe-add-streams/docs/project-overview/project-overview/licenses/elv2-license/README.md)
