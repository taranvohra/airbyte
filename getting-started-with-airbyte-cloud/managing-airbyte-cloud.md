...
_Note: Airbyte_ [_credits_](https://airbyte.com/pricing) _are assigned per workspace and cannot be transferred between workspaces._
...
4. On the Add new users window, enter the email address of the user you want to invite to your workspace. Click **Send invitation**.\
   &#xNAN;_&#x4E;ote: The user will have access to only the workspace you invited them to. Also note that they will be added as a workspace admin by default._
