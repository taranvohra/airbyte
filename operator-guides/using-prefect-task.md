...
If you don't have a Prefect instance, we recommend following this [guide](https://docs.prefect.io/core/getting\_started/install.html) to set one up.
...
![](../.gitbook/assets/airbyte\_prefect\_connection.png)
...
![](../.gitbook/assets/airbyte\_prefect\_register\_flow.png)
...
![](../.gitbook/assets/airbyte\_prefect\_flow.png)

Click on the button `Run` and configure your first run. ![](../.gitbook/assets/airbyte\_prefect\_flow\_configure\_run.png)

After a few moments you should see the finished run.

![](../.gitbook/assets/airbyte\_prefect\_flow\_run.png)
