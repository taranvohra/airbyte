...
You can build a connector very quickly in C# .NET with the [Airbyte Dotnet CDK](https://github.com/taranvohra/airbyte/blob/master/docs/connector-development/cdk-dotnet/README.md), which generates 75% of the code required for you.
