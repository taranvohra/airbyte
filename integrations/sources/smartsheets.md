...
At the time of writing, the [Smartsheets API rate limit](https://developers.smartsheet.com/blog/smartsheet-api-best-practices) is 300 requests per minute per API access token. This connector makes 6 API calls per sync operation.
