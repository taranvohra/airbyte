...
| Format            | object | Format specific configuration. See the [spec](https://github.com/taranvohra/airbyte/tree/bazarnov/stripe-add-streams/airbyte-integrations/connectors/destination-s3/src/main/resources/spec.json) for details. |
